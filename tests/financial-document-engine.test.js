...
test('document detail query builds a PostgreSQL bind marker for public id',()=>{
  assert.ok(core.includes("const publicIdBind='$'+params.length"));
  assert.ok(core.includes('d.public_id=${publicIdBind}'));
});
