...
const finance=read('server-delivery-finance.js'),delivery=read('server-delivery.js'),suppliers=read('server-suppliers.js'),services=read('server-services.js');
...
test('already parsed JSON is preserved through Delivery until Local Services reaches Marketplace',()=>{
