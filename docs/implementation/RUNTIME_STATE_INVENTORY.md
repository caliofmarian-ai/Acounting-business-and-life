...
| `abl_active_role` | Legacy local-storage role | Stale client value mounted Merchant tools before authorization/bootstrap completed | Removed from mobile feature-loader decisions; delete remaining writes/readers in later slices |
