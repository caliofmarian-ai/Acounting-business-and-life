...
function decorateDrawer(){
  const panel=document.getElementById('profileDrawerPanel');if(!panel||!currentProfile||panel.querySelector('.securityCard'))return;
