...
async function submitAuth(e){
  ...
  try{
    ...
    const payload=isRegistration?{display_name:document.getElementById('authName').value,email,password,phone:document.getElementById('authPhone').value,address:document.getElementById('authAddress').value,...(referralConversion?{referral_conversion:referralConversion}:{})}:{email,password};
